...
xcopy %FontFile% .\ /Y
call cl -I%SDL2_Include% %CLFlags% -nologo -Zi -EHsc %SourceFiles% -Fe%OutputName% /link /LIBPATH:%SDL2_Library% SDL2.lib SDL2main.lib Shell32.lib /LIBPATH:%SDL2_ttf_Library% SDL2_ttf.lib /subsystem:console
popd
